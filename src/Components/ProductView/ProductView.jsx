  ...
  return (
    <div className='rounded-[20px] overflow-hidden hover:cursor-pointer shadow-xl hover:shadow-2xl transition-time z-0'>
        <div className='overflow-hidden'>
            <img src={"http://192.168.1.20:8080/product/image/"+props.image} className='w-full xl:h-[450px] md:h-[370px] sm:h-[320px] h-[250px] hover:scale-110 transition-time hover:fill-transparent' alt="product" />
        </div>
