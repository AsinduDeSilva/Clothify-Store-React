  ...
  return (
    <div className=' bg-[#D9D9D9] overflow-hidden'>
        <Grid container spacing={2} >
          <Grid xs={12} lg={3}>
            <div className='xl:h-[220px] sm:h-[150px] h-[120px] flex items-center justify-center '>
              <img src={logo} alt="logo" className='sm:h-[80px] h-[70px] p-1  ' />
            </div>
          </Grid>
          <Grid xs={12} sm={4} lg={3}>
            <div className='xl:mt-10 ml-12'>
              <span className='font-semibold xl:text-xl xs:text-lg'>Contact Us</span><br />
          ...
          <Grid xs={12} sm={4} lg={3}>
            <div className='xl:mt-10 ml-12 sm:ml-0'>
              <span className='font-semibold xl:text-xl xs:text-lg '>Openning Hours</span><br />
              <div className='mt-5 xl:text-[16px] xs:text-sm text-xs'>
          ...
          <Grid xs={12} sm={4} lg={3}>
          <div className='xl:mt-10 ml-12 sm:ml-0'>
              <span className='font-semibold xl:text-xl xs:text-lg'>Company Details</span><br />
              <div className='mt-5 xl:text-[16px] xs:text-sm text-xs'>
          ...
          <Grid xs={12} >
            <div className='bg-black text-white border-t py-3 border-black flex justify-center xl:text-md xs:text-sm text-xs'>
              © 2023 Clothify Store. All rights reserved.
            </div>
          </Grid>
        </Grid>
      </div>
